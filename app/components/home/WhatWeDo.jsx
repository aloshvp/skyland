                ...
                <div className="row justify-content-center">
                    <div className="col-lg-10">
                        <div className="whatWeDoHead">
                            <h2 data-aos="fade-up" data-aos-duration="600" data-aos-delay="0">What We Do?</h2>
                            <p data-aos="fade-up" data-aos-duration="600" data-aos-delay="50">At Skyland Buildings & Construction, we turn visions into lasting structures. From residential and commercial spaces to custom builds, we deliver quality, precision, and on-time results — building not just projects, but lasting trust.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className="whatWeDoGrid">
                <div className="whatWeDoGridItem item1" data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
                ...
                <div className="whatWeDoGridItem item2" data-aos="fade-up" data-aos-duration="600" data-aos-delay="150">
                ...
                <div className="whatWeDoGridItem item3" data-aos="fade-up" data-aos-duration="600" data-aos-delay="200">
