                ...
                <div className="bestWorkOverlay">
                    <div className="container h-100">
                        <div className="bestWorkHeader">
                            <h2 className="sectionTitle" data-aos="fade-up" data-aos-duration="800"><em>View Some of Our</em> Best Work</h2>
                            <div className="bestWorkControls" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                        ...
                        <div className="bestWorkFooterExternal">
                            <div className="activeSlideInfo" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                                <h3>{bestWorkSlides[activeIndex]?.title}</h3>
                                <p>{bestWorkSlides[activeIndex]?.description}</p>
                            </div>

                            <div className="thumbsSliderWrap" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                                <Swiper
