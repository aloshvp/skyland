                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="postTensionContent">
                            <span data-aos="fade-up" data-aos-duration="600" data-aos-delay="0">Kerala's No 1</span>
                            <h2 data-aos="fade-up" data-aos-duration="600" data-aos-delay="50">Post Tension Experts</h2>
                            <p data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">Post-tensioning strengthens concrete by applying compressive stress using high-tensile steel tendons, counteracting tensile forces from load and weight. Strands specializes in bonded post-tensioning, which provides superior corrosion protection and durability-ideal for slabs, bridges, and complex structures.</p>
                            <Link href="" className='exploreBtn' scroll={false} data-aos="fade-up" data-aos-duration="600" data-aos-delay="150">Explore</Link>
                        </div>
                    </div>
                </div>
            </div>
